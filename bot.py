...
async def start(bot, message):
    await message.reply(
        ...
        "𝐈'𝐦 𝐚 𝐏𝐝𝐢𝐬𝐤 𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐫 𝐛𝐨𝐭. 𝐉𝐮𝐬𝐭 𝐬𝐞𝐧𝐝 𝐦𝐞 𝐥𝐢𝐧𝐤, 𝐟𝐢𝐥𝐞 𝐨𝐫 𝐅𝐮𝐥𝐥 𝐩𝐨𝐬𝐭...\𝐧\𝐧 𝐓𝐡𝐢𝐬 𝐛𝐨𝐭 𝐢𝐬 𝐦𝐚𝐝𝐞 𝐛𝐲 @phnx_botz")
...
async def remove_username(new_List):
    for i in new_List:
        if('@' in i or 't.me' in i or 'https://t.me/phnx_botz' in i or 'https://t.me/phnx_botz' in i or 'telegra.ph' in i):
            new_List.remove(i)
    return new_List
...
async def addFooter(str):
    footer = """
━━━━━━━━━━━━━━━
JOIN MY CHANNEL https://t.me/phnx_botz
━━━━━━━━━━━━━━━
